...
<body>
    ...
    @if (Auth::check())
            <form action="{{route('user.processUploading',Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div>
        ...
        @enderror form-control">
                ...
                <button class="btn btn-success mt-3 form-control">Upload</button>
            </form>
        @endif
    </div>
</div>
